      ...
      <Stack gap="large">
        <Stack gap="normal">
          {subscription ? (
            ...
            <Text color="secondary">No active subscription found.</Text>
          )}
        ...
        <Stack gap="normal">
          ...
          <Stack gap="small">
            {PLAN_FEATURES.map(({ label, planKey }) => {
              ...
              return (
                <Text key={label} color={enabled ? "primary" : "secondary"}>
                  {enabled ? "✓" : "✗"} {label}
                </Text>
              );
            })}
          ...
          >
            ...
            <Stack gap="small">
              {alternatePlan.features.map((feature) => (
                <Text key={feature} color="secondary">
        ...
        {subscription && !cancelAtPeriodEnd && (
          ...
          >
            <Text>
              Cancelling your subscription will deactivate your strata at the
